...
def Analise_Total(Geometria_Media, Centroide, Segundo_Momentos_De_Area, Forcas_Afilamento, Momentos, Elasticidades, Espessuras, Coordenadas_Y, Coordenadas_X):
    Altura_Media, Diametro_Medio, Area_Total, Area_Varrida = Geometria_Media
    ...
    Qb1 = Ex_1 * (Constante_A_Corte*(T1*Raio_Medio*Y1*math.pi + T1*(Raio_Medio**2)*(2) + A3*Y4) + Constante_B_Corte*(A3*X4)) + Qb4
    ...
    #Nao esta a dar zero pela simples razao de que trocos que se costumavam se anular, nao se estao a anular devido a trocos com modulos elasticos diferentes.
    #Causando corte nao nulo no ponto final. Possiveis solucoes sao colocar as contribuicoes no troco seguinte mas nao sei como implementar isto matematicamente.
