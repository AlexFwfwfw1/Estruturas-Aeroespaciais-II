...
def Momentos_Area(z, Laminado_1, Laminado_2, Laminado_3, b):
    ...
    x_2 = distancia_x_vertical_i
    x_3 = - distancia_x_vertical_i
    x_4 = - distancia_x_vertical_i
    y_1 = - y_CG
    y_2 = distancia_y_horizontal_i
    y_3 = distancia_y_horizontal_i
    y_4 = - y_CG

    return Ixx_total_i , Iyy_total_i , Ixy_total_i , y_CG , x_CG , h_altura_ii , w_diametro_ii , x_1 , x_2 , x_3 , x_4 , y_1 , y_2 , y_3 , y_4
